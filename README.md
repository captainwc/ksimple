...
[站点样式](https://wddjwk.github.io)

[文章样式](https://wddjwk.github.io/%E6%B5%8B%E8%AF%95/markdown-demo/)
...
## use ssh
git submodule add git@github.com:wddjwk/ksimple.git themes/ksimple
## use https
git submodule add https://github.com/wddjwk/ksimple.git themes/ksimple
# 3. config your hugo.yaml/hugo.toml like:
theme: ["ksimple"]
## ref: https://github.com/wddjwk/wddjwk.github.io/blob/main/hugo.yaml
```
